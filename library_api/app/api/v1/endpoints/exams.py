...
from app.schemas.exam import ExamListResponse, ExamCreate, ExamUpdate, ExamDetailResponse, ExamCreateResponse, \
    ExamUpdateResponse
...
# POST tạo exam
@router.post("/", response_model=ResponseModel[ExamCreateResponse], status_code=status.HTTP_201_CREATED
